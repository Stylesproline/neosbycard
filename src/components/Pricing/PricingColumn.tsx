    ...
    return (
        <div className={clsx("w-full max-w-sm mx-auto bg-white rounded-xl border border-gray-200 lg:max-w-full", { "shadow-lg": highlight })}>
            <div className="p-6 border-b border-gray-200 rounded-t-xl">
                ...
                <p className="text-3xl md:text-5xl font-bold mb-6">
                    <span className={clsx({ "text-secondary": highlight })}>
                        {typeof price === ' ' ? `$${price}` : price}
                    </span>
                    {typeof price === ' ' && <span className="text-lg font-normal text-gray-600"></span>}
                </p>
            ...
            <div className="p-6 mt-1">
                <p className="font-bold mb-0">Описание</p>
                <p className="text-foreground-accent mb-5">Единовременная плата </p>
